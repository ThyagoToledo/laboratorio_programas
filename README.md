...
* [Sumário de Atividades](#sumário-de-atividades)
  * [[1] Cálculos Geométricos](#1-cálculos-geométricos-senai_llp_variaveis_geometria)
    ...
    * [AreaTriangulo.java (Área do Triângulo)](N2/AreaTriangulo.java)
    * [AreaCirculo.java (Área do Círculo)](N2/AreaCirculo.java)
    * [AreaCaixa.java (Área da Caixa)](N2/AreaCaixa.java)
    * [AreaPiramide.java (Área da Pirâmide)](N2/AreaPiramide.java)
    * [AreaTubo.java (Área do Tubo/Cilindro)](N2/AreaTubo.java)
    * [AreaBola.java (Área da Esfera/Bola)](N2/AreaBola.java)
  * [[2] Simulador de Dados](#2-simulador-de-dados-senai_llp_dados)
    * [SimuladorDados.java (Simulador de Dados)](N2/SimuladorDados.java)
  * [[3] Livro de Receitas](#3-livro-de-receitas-senai_llp_file_livro-de-receitas)
    * [LivroDeReceitas.java (Livro de Receitas)](N2/LivroDeReceitas.java)
  * [[4] Análise de Texto](#4-análise-de-texto-senai_llp_analise-texto)
    * [Atividade01.java (Análise de Texto)](N2/Atividade01.java)
